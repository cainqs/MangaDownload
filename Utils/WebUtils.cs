...
namespace Utils
{
    ...
    public abstract class WebUtils
    {
        ...
        /// <returns>HTTP响应</returns>
        public async static Task<string> DoPost(string url, IDictionary<string, string> textParams, string fileDataParamatername, List<FileItem> fileParams)
        {
            // 如果没有文件参数，则走普通POST请求
            ...
            {
                string key = fileDataParamatername;
            ...
            return GetResponseAsString(((HttpWebResponse)rsp), Encoding.UTF8);
        }
